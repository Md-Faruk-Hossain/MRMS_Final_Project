...
import { VisaIssueCreateComponent } from './component/visaSection/visa-issue-create/visa-issue-create.component';
import { VisaIssueEditComponent } from './component/visaSection/visa-issue-edit/visa-issue-edit.component';
import { VisaIssueViewComponent } from './component/visaSection/visa-issue-view/visa-issue-view.component';
import { VisaIssueCommentCreateComponent } from './component/visaSection/visa-issue-comment-create/visa-issue-comment-create.component';
import { VisaIssueCommentEditComponent } from './component/visaSection/visa-issue-comment-edit/visa-issue-comment-edit.component';
import { VisaIssueCommentViewComponent } from './component/visaSection/visa-issue-comment-view/visa-issue-comment-view.component';
...
@NgModule({
  declarations: [
    ...
    VisaCreateComponent,
    VisaEditComponent,
    VisaIssueCreateComponent,
    VisaIssueEditComponent,
    VisaIssueViewComponent,
    VisaIssueCommentCreateComponent,
    VisaIssueCommentEditComponent,
    VisaIssueCommentViewComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
