...
const routes: Routes = [
  ...
  { path: 'visaIssue', component: VisaIssueViewComponent },
  { path: 'visaIssue-create', component: VisaIssueCreateComponent },
  { path: 'visaIssue-edit/:id', component: VisaIssueEditComponent },
